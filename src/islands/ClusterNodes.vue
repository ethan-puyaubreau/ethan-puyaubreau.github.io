...
// This site is static (GitHub Pages), and the telemetry endpoint lives on the
// creator's domain: fetching it live at runtime would be a standing
// cross-origin request from this page to that domain, on every visit.
