 ...
 *
 * Deux réalisations ci-dessous (Opération Endgame, l'annuaire communautaire)
 * sont volontairement abstraites : aucun nom de jeu, de plateforme ou de
 * communauté, aucun lien. Ce n'est pas un oubli. Les deux sont réelles et
 * toutes deux rattachées, ailleurs, à une identité que ce site ne nomme pas ;
 * un lecteur qui chercherait le titre exact retrouverait cette identité en
 * une requête. La forme du travail (un événement annuel en direct à 120+
 * participants ; un annuaire communautaire de 57 entrées, conçu et
 * auto-hébergé) est ce qui vaut la peine d'être montré.
 */
